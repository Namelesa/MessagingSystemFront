import { validateEmail, validatePassword, validateFirstName, validateLastName, validateNickName, validateLogin } from '../../../shared/validators';
...
export class RegisterFieldValidationHelper {
  ...
  static validateField(fieldName: keyof typeof RegisterFieldValidationHelper.FIELD_VALIDATORS, value: string): string[] {
  ...
  static validateImage(file: File | undefined): string[] {
    ...
    if (!(file instanceof File)) {
      return ['* Image must be a valid file'];
    }
