import { validatePassword, validateNickName, validateLogin } from '../../validators';
...
export class LoginFieldValidationHelper {
  ...
  static validateField(fieldName: keyof typeof LoginFieldValidationHelper.FIELD_VALIDATORS, value: string): string[] {
